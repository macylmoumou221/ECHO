...
export default function PasswordInput({ value, onChange, name = "password", label, showForgot = true }) {
  ...
  return (
    <div className="relative border-b border-gray-400 pb-0">
      ...
      <input
        ...
        onChange={onChange}
        required
        placeholder={label || language.login.password} // allow custom label/placeholder
